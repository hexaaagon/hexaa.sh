...
export default function HeroSection() {
  return (
    <section className="relative flex flex-col">
      <div className="inner relative flex h-[80vh] flex-col justify-around border-separator/10 border-x border-t px-4 *:transition-all sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:gap-0 lg:px-16">
