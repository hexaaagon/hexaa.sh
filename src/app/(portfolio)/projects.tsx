  ...
  return (
    <>
      <main className="w-full border-separator/10 border-t">
        <div className="inner relative flex h-8 border-separator/10 border-x">
      ...
      <main className="w-full border-separator/10 border-t">
        <div className="inner relative flex border-separator/10 border-x">
          ...
          <div className="flex grow flex-col">
            ...
            <div className="group relative flex h-[8rem] flex-col justify-center gap-4 overflow-hidden px-5 sm:h-[12rem] sm:px-10 md:px-18">
              ...
              <p className="max-w-[600px] text-xs leading-3.5 sm:text-sm sm:leading-6 md:text-base">
                ...
                skills and passion for software development. each project
                reflects my commitment to creating impactful solutions and
                continuous learning.
              </p>
            </div>
            <div className="flex w-full">
          ...
          <div className="absolute right-0 bottom-0 left-0 h-32 w-full bg-gradient-to-b from-transparent to-background"></div>
          <PlusSeparator position={["top-left", "top-right"]} />
        </div>
